% Solve for the problem (45) under low-resolution constraints.
...
function [X,Theta,tt] = get_X_theta_b(H_au,H_ar,H_ru,dist,power,b,Nmax,res_th)
...
%%% random initialize
theta = exp(1i*2*pi*rand(2*N,1));
theta = exp(1i*delta*round(angle(theta)/delta));
